...
(function (factory) {
    if (typeof module === 'object' && module.exports) {
        ...
        define('highcharts/modules/pyramid3d', ['highcharts', 'js/highcharts/highcharts-3d', 'js/highcharts/modules/cylinder', 'js/highcharts/modules/funnel3d'], function (Highcharts) {
            factory(Highcharts);
